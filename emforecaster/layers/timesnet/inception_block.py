# Taken from: https://github.com/thuml/emforecaster-Library/blob/main/layers/Conv_Blocks.py
import torch
...
class InceptionNet1D(nn.Module):
    def __init__(self, in_channels, num_blocks=3, out_channels=32, pool_size=2):
        ...
        self.inception_blocks = nn.ModuleList(
            [
                InceptionBlock1D(in_channels if i == 0 else out_channels, out_channels)
