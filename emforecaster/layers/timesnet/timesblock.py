...
from emforecaster.layers.timesnet.inception_block import InceptionBlock
...
def compute_periods(x, k=2):
    ...
    Taken from: https://github.com/thuml/emforecaster-Library/blob/main/models/TimesNet.py.
...
if __name__ == "__main__":
    ...
    model = TimesBlock(seq_len, pred_len, top_k, d_model, d_ff, num_kernels).to(device)
